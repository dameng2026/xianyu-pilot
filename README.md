...
- 🧩 **滑块求解** — 本地浏览器 + 远程 API 双通道，同账号 10 分钟内跨模块去重防重复扣费
...
> 📌 以下功能尚未在开源版实现，属于后续规划方向，具体上线时间以更新日志为准。

| 功能模块 | 说明 | 规划能力 |
|------|------|--------|
| 商品搜索 | 根据商品关键词爬取商品 | AI 搬运润色、生图、发布 |
| 店铺爬取 | 根据店铺链接爬取商品 | AI 搬运润色、生图、发布 |
| 工作流 | 按设定规则自动发布商品 | 多账号、多商品一次性发布 |
